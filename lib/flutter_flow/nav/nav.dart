...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'EditMenuItem',
          path: '/editMenuItem',
          builder: (context, params) => EditMenuItemWidget(
            docId: params.getParam(
                'docId', ParamType.DocumentReference, false, ['menu-items']),
          ),
        ),
        FFRoute(
          name: 'Orders',
          path: '/orders',
          asyncParams: {
            'menu': getDoc(['menu-items'], MenuItemsRecord.fromSnapshot),
          },
          builder: (context, params) => OrdersWidget(
            menu: params.getParam('menu', ParamType.Document),
          ),
        ),
        FFRoute(
          name: 'OrderDetails',
