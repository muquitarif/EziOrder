  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> ordersUsersRecordList = snapshot.data!;
        final ordersUsersRecord = ordersUsersRecordList.isNotEmpty
            ? ordersUsersRecordList.first
            : null;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: Colors.white,
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            'Order # ${listViewOrdersRecord.orderNum.toString()}',
