...
class _EditMenuItemWidgetState extends State<EditMenuItemWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<MenuItemsRecord>(
      stream: MenuItemsRecord.getDocument(widget.docId!),
      builder: (context, snapshot) {
        ...
        final editMenuItemMenuItemsRecord = snapshot.data!;
                        ...
                        children: [
                          InkWell(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.network(
                                editMenuItemMenuItemsRecord.image,
                                width: 300.0,
                                height: 200.0,
                                fit: BoxFit.cover,
                              ),
                            ...
                            children: [
                              Padding(
                                ...
                                child: TextFormField(
                                  controller: _model.textController1 ??=
                                    ...
                                    text: editMenuItemMenuItemsRecord.name,
                                  ),
                                  autofocus: true,
                                  obscureText: false,
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  controller: _model.textController2 ??=
                                      TextEditingController(
                                    text: editMenuItemMenuItemsRecord.price
                                        .toString(),
                                  ),
                                  autofocus: true,
                                  obscureText: false,
                                    ...
                                    child: Padding(
                                      ...
                                      child: TextFormField(
                                        controller: _model.textController3 ??=
                                            TextEditingController(
                                          text: editMenuItemMenuItemsRecord
                                              .category,
                                        ),
                                        autofocus: true,
                                        obscureText: false,
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    final menuItemsUpdateData =
                                        createMenuItemsRecordData(
                                      image: editMenuItemMenuItemsRecord.image,
                                      name: _model.textController1.text,
                                      price: int.tryParse(
                                          _model.textController2.text),
                                      category: _model.textController3.text,
                                    );
                                    await editMenuItemMenuItemsRecord.reference
                                        .update(menuItemsUpdateData);
