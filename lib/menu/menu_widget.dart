  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> menuUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final menuUsersRecord =
            menuUsersRecordList.isNotEmpty ? menuUsersRecordList.first : null;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: Colors.white,
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(
                                                                ...
                                                                10.0),
                                                    child: Text(
                                                      'Rs. ${listViewMenuItemsRecord.price.toString()}',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .bodyMedium
