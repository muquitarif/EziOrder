                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    '${dateTimeFormat(
                                      'yMMMd',
                                      orderDetailsOrdersRecord.createdAt,
                              ...
                              children: [
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 5.0),
                                  child: Text(
                                    'Customer : ${orderDetailsOrdersRecord.customerName}',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Readex Pro',
                              ...
                              children: [
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 5.0),
                                  child: Text(
                                    'Phone: ${orderDetailsOrdersRecord.customerPhone}',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Readex Pro',
                              ...
                              children: [
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 5.0),
                                  child: Text(
                                    'Address: ${orderDetailsOrdersRecord.customerAddress}',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Readex Pro',
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                  'Email: ${orderDetailsOrdersRecord.customerEmail}',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: 'Readex Pro',
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Rs. ${orderDetailsOrdersRecord.totalPrice.toString()}',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Readex Pro',
